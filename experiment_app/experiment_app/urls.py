...
urlpatterns = [
    ...
    path('api/projects/<int:exp_id>/description-sources/', views.search_experiment_description_sources, name='search_experiment_description_sources'),
    path('api/projects/<int:exp_id>/description-sources/<int:source_id>/', views.get_experiment_description_source, name='get_experiment_description_source'),
    ...
    path('management/projects/<int:project_id>/access/', views.grant_project_access, name='grant_project_access'),
    ...
    path('management/cell-test-items/add/', views.add_cell_test_item, name='add_cell_test_item'),
    path('management/cell-test-items/<int:item_id>/edit/', views.edit_cell_test_item, name='edit_cell_test_item'),
